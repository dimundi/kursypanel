    ...
    return (
        <footer className="training-footer">
            <div className="training-footer-surface">
                <div className="training-footer-top">
                    <section className="training-footer-intro" aria-labelledby="footer-platform-title">
                        ...
                        <nav className="training-footer-menu" aria-label="Linki platformy szkoleniowej">
                            <a className="training-footer-return" href="https://odnrewers.pl/">← Wróć do strony Rewers</a>
                            <Link to="/pliki"><span aria-hidden="true">→</span>Pliki do pobrania</Link>
                        </nav>
                    </section>
                    <section className="training-footer-contact" aria-label="Dane kontaktowe">
                        <h2>Biuro obsługi i kontaktu<br />z klientami:</h2>
                        <div className="training-footer-contact-columns"><dl>
                            <dt>ADRES:</dt><dd>ul. Glazurowa 21/4,<br />80-180 Kowale<br />k. Gdańska</dd>
                        </dl><dl>
                            <dt>TEL.:</dt><dd>57 532 12 22</dd>
                            <dt>EMAIL:</dt><dd>biuro@odnrewers.pl</dd>
                        </dl></div>
                    </section>
                ...
                <Link className="training-footer-logo" to="/" aria-label="Rewers — platforma szkoleniowa"><img src={logo} alt="REWERS" /></Link>
            </div>
        </footer>
    );
}